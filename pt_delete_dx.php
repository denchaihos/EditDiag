...
if($_POST[visit_type]=="O"){
    ...
    $result = mysql_query($sql,$con);
    $obj = mysql_fetch_object($result);
    $sqlinsert = "insert into iptdx_original_dx (id,an,itemno,dct,icd10,icd10name,spclty,date_update,flag_status) values ('$obj->id','$obj->an','$obj->itemno','$obj->dct','$obj->icd10','$obj->icd10name','$obj->spclty',now(),'de')";
    mysql_query($sqlinsert);
    $sql =  "delete from iptdx  where id = ".$_POST[id_dx]."";
    mysql_query($sql);
}
